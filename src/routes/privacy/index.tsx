  ...
  return (
    <section class="flex mx-auto max-w-7xl px-6 items-center justify-center min-h-[calc(100lvh-68px)]">
      <div class="my-10 space-y-3 min-h-[60px]">
        ...
        <p class="pl-5">You may opt out of any data collection unrelated to necessary functioning. Necessary functioning data collection includes server access logs. You may disable your browser cookies or cede use of our site to opt out of cookies.</p>
